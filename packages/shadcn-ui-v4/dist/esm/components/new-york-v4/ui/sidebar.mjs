import { TooltipProvider, Tooltip, TooltipTrigger, TooltipContent } from '../../../chunk-U64MMXQK.mjs';
import { Skeleton } from '../../../chunk-3NOC4B6N.mjs';
import { Separator } from '../../../chunk-IQDCCYE7.mjs';
import { Sheet, SheetHeader, SheetTitle, SheetDescription, SheetContent } from '../../../chunk-PCRMHNZ7.mjs';
import { Input } from '../../../chunk-W3QLY35U.mjs';
import { useIsMobile } from '../../../chunk-WNV4FATE.mjs';
import { cn } from '../../../chunk-DELC4UPM.mjs';
...
function Sidebar({
  ...
  if (isMobile) {
    return /* @__PURE__ */ React.createElement(Sheet, { open: openMobile, onOpenChange: setOpenMobile, ...props }, /* @__PURE__ */ React.createElement(SheetHeader, { className: "sr-only" }, /* @__PURE__ */ React.createElement(SheetTitle, null, "Sidebar"), /* @__PURE__ */ React.createElement(SheetDescription, null, "Displays the mobile sidebar.")), /* @__PURE__ */ React.createElement(
      SheetContent,
      {
